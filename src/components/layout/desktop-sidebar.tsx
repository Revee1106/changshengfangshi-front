...
export function DesktopSidebar({ items, pathname }: DesktopSidebarProps) {
  return (
    <aside className="sticky top-0 hidden h-screen border-r border-stone-200/80 bg-rice-50/82 px-3 py-5 backdrop-blur md:block">
      <Link href="/" className="mb-7 flex items-center gap-3 rounded-lg px-2 py-2">
        ...
        <span>
          ...
          <span className="block text-xs text-stone-500">修士前台</span>
        </span>
      </Link>
